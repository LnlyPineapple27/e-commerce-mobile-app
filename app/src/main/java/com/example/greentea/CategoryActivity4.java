...
public class CategoryActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sweather");
        recyclerView = findViewById(R.id.recycler_category4);
        ...
        Query query2 = aa2.orderByChild("category").equalTo("Sweathers");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CategoryActivity4.this, ProductDetailsActivity.class);
