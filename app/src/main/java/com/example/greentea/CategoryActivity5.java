...
public class CategoryActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Glasses");
        recyclerView = findViewById(R.id.recycler_category5);
        ...
        Query query2 = aa2.orderByChild("category").equalTo("Glasses");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CategoryActivity5.this, ProductDetailsActivity.class);
