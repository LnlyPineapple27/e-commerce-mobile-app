...
public class CategoryActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_category9);
        ...
        Query query2 = aa2.orderByChild("category").equalTo("HeadPhones HandFree");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CategoryActivity9.this, ProductDetailsActivity.class);
