...
public class CategoryActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Tshirt");
        recyclerView = findViewById(R.id.recycler_category1);
        ...
        Query query2 = aa2.orderByChild("category").equalTo("tShirts");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CategoryActivity1.this, ProductDetailsActivity.class);
