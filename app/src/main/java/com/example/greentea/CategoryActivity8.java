...
public class CategoryActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_category8);
        ...
        Query query2 = aa2.orderByChild("category").equalTo("Shoes");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(CategoryActivity8.this, ProductDetailsActivity.class);
